...
> 这篇推文是我觉得很好的值传递解析了，这位大佬也很强的喔，可以去关注一波，有益无害。(二维码放文末)

​	<font color=#FF0000>给全文表个态: 在Java参数传递中只有值传递，对于基本类型就不用说明，但对于对象来说，它传递的是一个对象的引用，并非一个对象的值。</font>
...
![](F:\笔记\java_Study\CSDN\assets\值内存分布情况.png)
...
![](F:\笔记\java_Study\CSDN\assets\值内存分布情况2.png)
...
![](F:\笔记\java_Study\CSDN\assets\hollis二维码.jpg)