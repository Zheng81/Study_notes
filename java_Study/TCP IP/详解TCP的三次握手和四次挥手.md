...
![](F:\笔记\java_Study\TCP IP\assets\TCP1.jpg)

TCP 连接建立

![](F:\笔记\java_Study\TCP IP\assets\TCP2.jpg)

TCP 连接断开

![](F:\笔记\java_Study\TCP IP\assets\TCP3.jpg)

Socket 编程

![](F:\笔记\java_Study\TCP IP\assets\TCP4.jpg)

------

## 1、TCP基本认识

![](F:\笔记\java_Study\TCP IP\assets\TCP5.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP6.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP7.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP8.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP9.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP10.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP11.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP12.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP13.jpg)

一开始，客户端和服务端都处于 `CLOSED` 状态。先是服务端主动监听某个端口，处于 `LISTEN` 状态

![](F:\笔记\java_Study\TCP IP\assets\TCP14.jpg)

客户端会随机初始化序号（`client_isn`），将此序号置于 TCP 首部的「序号」字段中，同时把 `SYN` 标志位置为 `1` ，表示 `SYN` 报文。接着把第一个 SYN 报文发送给服务端，表示向服务端发起连接，该报文不包含应用层数据，之后客户端处于 `SYN-SENT` 状态。

![](F:\笔记\java_Study\TCP IP\assets\TCP15.jpg)

- 服务端收到客户端的 `SYN` 报文后，首先服务端也随机初始化自己的序号（`server_isn`），将此序号填入 TCP 首部的「序号」字段中，其次把 TCP 首部的「确认应答号」字段填入 `client_isn + 1`, 接着把 `SYN`和 `ACK` 标志位置为 `1`。最后把该报文发给客户端，该报文也不包含应用层数据，之后服务端处于 `SYN-RCVD` 状态。

![](F:\笔记\java_Study\TCP IP\assets\TCP16.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP17.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP18.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP19.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP20.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP21.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP22.jpg)

过 TCP 层分片后，如果一个 TCP 分片丢失后，**进行重发时也是以 MSS 为单位**，而不用重传所有的分片，大大增加了重传的效率。
...
![](F:\笔记\java_Study\TCP IP\assets\TCP23.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP24.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP25.jpg)

应用程序过慢：

- 如果应用程序过慢时，就会导致「 Accept 队列」被占满。

![](F:\笔记\java_Study\TCP IP\assets\TCP26.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP27.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP28.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP29.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP30.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP31.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP32.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP33.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP34.jpg)
...
![](F:\笔记\java_Study\TCP IP\assets\TCP35.jpg)
